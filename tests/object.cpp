...
TEST(TestSuite, track_ball_orange0000)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0000");
}


TEST(TestSuite, track_ball_orange0001)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0001");
}


TEST(TestSuite, track_ball_orange0002)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0002");
}


TEST(TestSuite, track_ball_orange0003)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0003");
}


TEST(TestSuite, track_ball_orange0004)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0004");
}


TEST(TestSuite, track_ball_orange0005)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0005");
}


TEST(TestSuite, track_ball_orange0006)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0006");
}


TEST(TestSuite, track_ball_orange0007)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0007");
}


TEST(TestSuite, track_ball_orange0008)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0008");
}


TEST(TestSuite, track_ball_orange0009)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0009");
}


TEST(TestSuite, track_ball_orange0010)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0010");
}


TEST(TestSuite, track_ball_orange0011)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0011");
}


TEST(TestSuite, track_ball_orange0012)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0012");
}


TEST(TestSuite, track_ball_orange0013)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0013");
}


TEST(TestSuite, track_ball_orange0014)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0014");
}


TEST(TestSuite, track_ball_orange0015)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0015");
}


TEST(TestSuite, track_ball_orange0016)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0016");
}


TEST(TestSuite, track_ball_orange0017)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0017");
}


TEST(TestSuite, track_ball_orange0018)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0018");
}


TEST(TestSuite, track_ball_orange0019)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0019");
}


TEST(TestSuite, track_ball_orange0020)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0020");
}


TEST(TestSuite, track_ball_orange0021)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0021");
}


TEST(TestSuite, track_ball_orange0022)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0022");
}


TEST(TestSuite, track_ball_orange0023)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0023");
}


TEST(TestSuite, track_ball_orange0024)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0024");
}


TEST(TestSuite, track_ball_orange0025)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0025");
}


TEST(TestSuite, track_ball_orange0026)
{
  std::vector<std::string> ball_orange_models;
  ball_orange_models.push_back("./data/models/ball-orange-3");
  trackObject(ball_orange_models,
              "./data/frames/ball-orange-frame0026");
}
